...
require File.dirname(__FILE__) + "/lib/full_tilt/version"

Gem::Specification.new do |s|
  s.name                      = "full_tilt"
  s.version                   = FullTilt::VERSION
  ...
  s.files = Dir.glob(%w[{lib,test}/**/*.rb bin/* [A-Z]*.{txt,rdoc,md} ext/**/*.{rb,c} **/deps.rip]) + %w{Rakefile full_tilt.gemspec }
  # s.files += ['.rspec']
